    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 mt-3">
                <form action="/Query" method="GET">
                    <div class="input-group mb-3">
                        ...
                        <input autofocus type="text" class="form-control  " name="search" placeholder="" aria-label="codigo" aria-describedby="basic-addon1">
            ...
            <div class="col-md-6">
                ...
                <ul class="list-group">
                    @foreach($ordenes as $orden)
                        <li class="list-group-item active">Tu equipo es: <h3>{{ $orden->nombreEquipo }}</h3></li>
                        <li class="list-group-item">fecha de ingreso: {{ $orden->fechaEntrada }}</li>
                        <li class="list-group-item ">Estado: <span class="badge text-bg-primary">{{ $orden->estado }}</span> </li>
                    @endforeach
                </ul>
            @endif
            </div>
